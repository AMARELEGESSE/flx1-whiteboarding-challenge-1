...
function genBuzz(lower,upper){
    if(typeof lower === 'number' && typeof upper === 'number'){
      if(lower >= upper){
        console.log(`${lower} is higher than ${upper}`)
      }
      ...
      console.log(`${upper} is not a valid higher limit, please enter a number`)
    }else if(typeof upper === 'number' && typeof lower !== 'number'){
